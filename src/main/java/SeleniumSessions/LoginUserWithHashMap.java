...
public class LoginUserWithHashMap {
	...
	public static void main(String[] args) {
		...
		// RBAC User permission baser scenarios
		// product data: price name of the product<name:"macbook"> <price>
		// cutomer,admin user, categorymanager,seller,vendor,distributor
